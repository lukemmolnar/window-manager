    ...
    switch (cmd) {
      ...
      case 'help':
        ...
        response = [
          ...
          adminCommands,
          '  join-party (jp) <id|name> - Join a party',
          '  leave-party (lp) - Leave your current party',
          '  party (p) - Show your current party info',
          '  parties list (pl) - List all available parties',
      ...
      case 'create-party':
        ...
        // Extract party name from quotes or just take the second argument
        ...
        if (!partyName) {
          response = 'Usage: create-party "Party Name"';
          break;
        }
      ...
      case 'join-party':
        if (parts.length < 2) {
          response = 'Usage: join-party <party_id or party_name>';
          break;
        }
        
        const partyIdentifier = parts.slice(1).join(' ');
      ...
      case 'parties':
        if (parts.length > 1 && parts[1].toLowerCase() === 'list') {
          ...
          try {
            ...
            if (!currentParty) {
              response = 'You are not currently in a party. Use "parties list" to see available parties or "join-party <id>" to join one.';
            } else {
